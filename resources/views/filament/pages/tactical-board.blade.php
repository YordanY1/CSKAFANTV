<x-filament-panels::page>
    @vite('resources/js/tactical-board.js')
    ...
    <div x-data="tacticBoard()" x-init="init()" class="space-y-6">
        <div class="max-w-4xl mx-auto w-full space-y-4">
            ...
            <div class="flex flex-wrap gap-2">
                ...
                <button @click="clearBoard"
                    class="ml-auto text-sm text-red-600 border border-red-300 px-4 py-2 rounded hover:bg-red-50 transition">
                    🧹 Изчисти дъската
                </button>
        ...
        <div id="tactic-stage" class="mx-auto border-2 border-gray-300 rounded shadow-lg"
